    ...
    <div className="min-h-screen bg-[#020617] flex flex-col md:flex-row text-slate-100" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <aside className="hidden md:flex flex-col w-[260px] bg-[#070d1e] border-r border-cyan-500/10 shrink-0 sticky top-0 h-screen overflow-y-auto">
        ...
        <div className="px-5 py-4 border-b border-slate-800/60">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-cyan-400/60 text-[9px] font-bold">NIC Operations Room</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 py-4 border-t border-slate-800/60 space-y-2">
          <Link href="/" className="flex items-center space-x-2 px-3 py-2 rounded-lg text-xs text-slate-500 hover:text-slate-300 hover:bg-slate-800/40 transition-colors">
        ...
        <header className="sticky top-0 z-40 bg-[#070d1e]/80 backdrop-blur-xl border-b border-cyan-500/10">
          <div className="flex items-center justify-between px-4 md:px-8 h-14">
            ...
            <div className="hidden md:flex items-center space-x-2 text-xs text-slate-500">
              <Shield className="w-3.5 h-3.5 text-cyan-400/80 animate-pulse" />
              <span>National CommandCenter</span>
              <ChevronRight className="w-3 h-3" />
              <span className="text-slate-300 font-medium">{sidebarLinks.find(l => isActive(l))?.label || 'Overview'}</span>
            </div>

            {/* Actions */}
            <div className="flex items-center space-x-3">
              <div className="hidden sm:flex items-center space-x-1 px-2.5 py-1 rounded-lg bg-cyan-500/10 border border-cyan-500/20">
                <Sparkles className="w-3 h-3 text-cyan-400 animate-pulse" />
                <span className="text-[10px] font-bold text-cyan-300 tracking-wider">SECURE LINK</span>
              </div>
