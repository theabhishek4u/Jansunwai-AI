...
export default function LandingPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Fully accessible in native languages, ensuring rural communities, farmers, and students can raise complaints comfortably."
    }
  ];
  ...
  const faqData = {
    general: [
      ...
      { q: "Is this platform free for citizens?", a: "Yes, it is completely free for all citizens of India to raise development complaints, upload photos, and track execution." }
    ],
    ai: [
      { q: "How does the AI process suggestions?", a: "When you submit a complaint, the Gemini 2.5 Flash model scans it for duplicates, validates the attached images using vision models, calculates a completeness score, and tags the location using coordinates." },
          ...
          <div className="bg-linear-to-tr from-slate-900/60 to-indigo-950/20 border border-slate-900 rounded-[3rem] p-10 md:p-16 relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 text-center">
              ...
              <div>
                ...
                <span className="block mt-2 text-xs md:text-sm text-slate-400 font-medium">Complaints Submitted</span>
              </div>
              <div>
